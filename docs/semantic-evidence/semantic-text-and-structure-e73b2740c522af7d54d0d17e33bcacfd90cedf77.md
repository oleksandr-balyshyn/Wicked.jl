...
| Widget family scope | Text and structure |
...
The Text and structure family is covered by family-evidence and widget coverage audits with stable candidate rows and semantic command output archived for this commit.
