...
| Widget family scope | Testing and semantics |
...
The Testing and semantics family is covered by family-evidence and widget coverage audits with stable candidate rows and semantic command output archived for this commit.
