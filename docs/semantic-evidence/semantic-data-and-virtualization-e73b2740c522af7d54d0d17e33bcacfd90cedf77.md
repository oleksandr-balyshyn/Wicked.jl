...
| Widget family scope | Data and virtualization |
...
The Data and virtualization family is covered by family-evidence and widget coverage audits with stable candidate rows and semantic command output archived for this commit.
