...
| Widget family scope | Core layout |
...
The Core layout family is covered by family-evidence and widget coverage audits with stable candidate rows and semantic command output archived for this commit.
