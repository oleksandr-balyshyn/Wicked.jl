...
| Terminal emulator, version, TERM, and COLORTERM | xterm-truecolor, TERM=xterm-256color, COLORTERM=truecolor |
...
The Truecolor terminal evidence relies on PTY sequence restore checks and environment control-path validation from this commit.

## Risks and follow-up

Full truecolor negotiation to be captured in native terminal matrix follow-up.
