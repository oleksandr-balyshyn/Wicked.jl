...
| Exit status | 0 |
| Documentation artifact path or CI URL | docs/documentation-evidence/artifacts/doc-build-e73b274.md |
...
Manual Documenter gate executed once under the release candidate and produced `docs/documentation-evidence/artifacts/doc-build-e73b274.md` with stable API pages and example-family entries.
